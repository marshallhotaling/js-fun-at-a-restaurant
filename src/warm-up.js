...
console.log (inStock - 1 ,'got a little snack')

// Initialize a new variable "isFavorite", and assign it to a boolean value indicating
// if the food you chose is your favorite food or not
var isFavorite = true 
if (isFavorite === true) { 
    console.log("this is my favret")
...
var vegetables = ['carrots','lettoce','potatos','tomatos','cabbige']
...
// different fruits.
var fruits = ['apples','orenges','mangos','strawberrys','bannanas','guava','drangon frute ']
...
groceryStore.location = "colorado" 
